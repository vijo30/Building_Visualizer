...
def createScene(pipeline):
    plane = createGPUShape(pipeline, bs.createTextureQuad(1.0, 1.0))
    plane.texture = es.textureSimpleSetup(
        getAssetPath("Road_001_basecolor.jpg"), GL_REPEAT, GL_REPEAT, GL_NEAREST, GL_NEAREST)
